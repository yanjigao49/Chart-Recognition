...
def apply_nms(output, iou_threshold=0.5, score_threshold=0.80):
    boxes = output['boxes']
...
def predict_scatter(image_path, model_weight_path='scatter_detector_500.pth', iou_threshold=0.5,
                         score_threshold=0.5, num_classes=2, save_visualization=False, save_path=None):
...
# Example usage
#image_path = 'test/images/0a3adf82c74c.jpg'
#output = predict_scatter(image_path, save_visualization=True)
#print(output)
